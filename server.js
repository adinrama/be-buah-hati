...
const init = async () => {
  ...
  server.route({
    ...
    handler: async (request, h) => {
      const { gender, age, weight, height, headCircumference, weightAgeGender, heightAgeGender, headCircumferenceAgeGender, weightHeight } = request.payload;
      ...
      try {
        ...
        return h.response({ summaryText }).code(200);
      } catch (error) {
